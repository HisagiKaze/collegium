...
/* ******************************************************* */
	...
	static boolean IA (int [] [] tab_score, String [] tab_firstname, int index) {
		...
		if (tab_firstname[index].compareToIgnoreCase("IA") == 0)
		{
			i = 0;
			po_scores = new int [13];
			btest = false;
			init_simple_tab(po_scores, 0);
			while(i < tab_score.length && btest == false)
			{
...
/* ******************************************************* */
	...
	static int IME (int i) {
		...
		if (i == 1)
		{
			do {
				try {
					System.out.println("(Si vous voulez une IA, ajoutez +1 aux nombre de joueurs)");
...
/* ******************************************************* */
	...
	static void init_tab_firstname (String [] tab_firstname, int nb_player) {
		...
		{
			System.out.println("(Si vous souhaitez une IA, entrez \"IA\" pour le nom du joueur)");
...
/* ******************************************************* */
	...
	static int winner_name (int [] [] tab_score, String [] tab_firstname, int [] tab_wins) {
		...
		System.out.print("avec " + x + " points !");
		return (nb_winner);
	}

/* ******************************************************* */
/*  The main fonction is where start and end the programm. */
/*	It ask the number of player. If you want an IA to play */
/*	with or not.It also count the thirteen tours and show  */
	...
	public static void main (String [] args) {
		...
		while (p_again)
		{
			...
			while (i++ < 13)
			{
				...
				{
					if (!IA(tab_score, tab_firstname, index))
					{
